...
export const RESOURCES: Record<string, ResourceType> = {
  ...
  // Harvested from the living world (creatures, fish, birds, flora).
  biomass: { id: 'biomass', name: 'Biomass', tier: 'common', color: 0xc0563a, value: 6, hardness: 1 },
  wood: { id: 'wood', name: 'Hardwood', tier: 'common', color: 0x6e4a2a, value: 4, hardness: 1 },
